# alimup 
######this is a fork form [meteor up](https://github.com/kadirahq/meteor-up), but let mongo can be connected outside localhost.
...
module.exports = {
  ...
  meteor: {
    ...
    //*mongohost: "your host for mongodb*  defaut is 127.0.0.1
  },
